    ...
    func setBarItem(){
      ...
      //  home.selectedImage = UIImage.fontAwesomeIcon(name: .home, style: .solid, textColor: UIColor.black, size: CGSize(width: 40, height: 40)).withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
       // home.imageInsets = UIEdgeInsets(top: 6, left: 0, bottom: -6, right: 0)
        home.image = UIImage.fontAwesomeIcon(name: .home, style: .solid, textColor: UIColor.black, size: CGSize(width: 30 , height: 30))
        
        home.imageInsets = UIEdgeInsets(top: 5, left: 0, bottom: 0, right: 0)
        ...
        cart.image = UIImage.fontAwesomeIcon(name: .shoppingCart, style: .solid, textColor: UIColor.black, size: CGSize(width: 30 , height: 30))
        
        cart.imageInsets = UIEdgeInsets(top: 5, left: 0, bottom: 0, right: 0)
         cart.titlePositionAdjustment = UIOffset(horizontal: 0.0,vertical: 1.0)
        
        
        let profile = (self.tabbar.items?[2])! as UITabBarItem
        
        profile.image = UIImage.fontAwesomeIcon(name: .user, style: .solid, textColor: UIColor.black, size: CGSize(width: 30, height: 30))
        
        profile.imageInsets = UIEdgeInsets(top: 5, left: 0, bottom: 0, right: 0)
        profile.titlePositionAdjustment = UIOffset(horizontal: 0.0,vertical: 1.0)
